...
const Events = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Event Entertainment Dubai | Weddings, Parties, Corporate | Box Entertainment</title>
        <meta name="description" content="Professional event entertainment services in Dubai. Weddings, birthday parties, corporate events, and marriage proposals. Complete planning, entertainment, and production services." />
