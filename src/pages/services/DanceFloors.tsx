...
const DanceFloors = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>LED Dance Floor Rental Dubai | Light-Up & Traditional Floors | Box Entertainment</title>
        <meta name="description" content="Professional LED and traditional dance floor rental in Dubai. Custom RGB lighting, sizes up to 30ft. Perfect for weddings, corporate events, parties. Safe installation." />
          ...
          <div className="space-y-4">
            <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
              <iframe
                ...
                title="LED dance floor with RGB lighting at Dubai wedding reception"
            ...
            <p className="text-center text-muted-foreground">
              LED dance floor with RGB lighting at Dubai wedding reception
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
              <iframe
                ...
                height="100%"
                src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                title="Sound-reactive LED dance floor at corporate gala event"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="w-full h-full"
              />
            ...
            <p className="text-center text-muted-foreground">
              Sound-reactive LED dance floor at corporate gala event
            </p>
          </div>
        </div>
