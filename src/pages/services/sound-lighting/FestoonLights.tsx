...
const FestoonLights = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Festoon & Fairy Lights Dubai | Outdoor Event Lighting Rental | Box Entertainment</title>
        <meta name="description" content="Professional festoon lights and fairy lights rental in Dubai. Edison bulbs, LED options for weddings, gardens, outdoor venues. Custom installations from AED 1,500. Expert rigging and setup." />
