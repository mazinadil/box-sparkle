...
const Entertainment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Entertainment Services Dubai | Box Entertainment</title>
        <meta name="description" content="Book professional entertainment for your Dubai event. DJs, magicians, dancers, bands, singers, comedians, and more." />
