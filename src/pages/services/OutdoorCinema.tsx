...
const OutdoorCinema = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Outdoor Cinema Rental Dubai | Movie Nights Under Stars | Box Entertainment</title>
        <meta name="description" content="Professional outdoor cinema rental in Dubai. Big screen movie experiences with HD projectors, surround sound, seating, popcorn & candy floss. From AED 3,000. Perfect for events, parties, corporate functions." />
            ...
            <CarouselItem className="md:basis-1/2 lg:basis-1/3">
              <Card className="overflow-hidden">
                <img
                  ...
                  alt="Large outdoor cinema screen at corporate event in Dubai"
                  className="w-full h-64 object-cover"
                  loading="lazy"
                />
              </Card>
            ...
            <CarouselItem className="md:basis-1/2 lg:basis-1/3">
              <Card className="overflow-hidden">
                <img
                  ...
                  alt="Outdoor cinema setup at private party with comfortable seating arrangements"
                  className="w-full h-64 object-cover"
                  loading="lazy"
                />
              </Card>
            ...
            <CarouselItem className="md:basis-1/2 lg:basis-1/3">
              <Card className="overflow-hidden">
                <img
                  ...
                  alt="Outdoor cinema combined with festoon lighting at Dubai garden party"
                  className="w-full h-64 object-cover"
                  loading="lazy"
                />
              </Card>
