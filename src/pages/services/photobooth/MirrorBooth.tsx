...
const MirrorBooth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mirror Photo Booth Dubai & UAE | Interactive Touch Screen | Box Entertainment</title>
        <meta name="description" content="Book our interactive mirror photo booth in Dubai & UAE. Full-length touch-screen mirror with instant prints, voice prompts & custom animations for weddings & events." />
                ...
                <Card key={index} className="backdrop-blur-sm bg-card/50 hover:shadow-lg transition-all">
                  <CardContent className="p-6 space-y-4">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-primary/10">
                      <inclusion.icon className="h-7 w-7 text-primary" />
                    </div>
              ...
              <div className="space-y-4">
                <div className="aspect-video bg-muted rounded-xl overflow-hidden">
                  <iframe
                    ...
                    title="Mirror booth at Dubai wedding"
              ...
              <div className="space-y-4">
                <div className="aspect-video bg-muted rounded-xl overflow-hidden">
                  <iframe
                    className="w-full h-full"
                    src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                    title="Corporate event mirror booth"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                  />
                </div>
