...
const Booth360 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>360 Degree Photo Booth Dubai & UAE | Slow Motion Video Booth | Box Entertainment</title>
        <meta name="description" content="Book our viral-worthy 360° video booth for slow-motion videos from every angle. Perfect for weddings, corporate events & parties in Dubai & UAE. Instant digital sharing." />
              ...
              <div className="space-y-4">
                <div className="aspect-video rounded-lg overflow-hidden bg-muted">
                  <iframe
                    ...
                    title="360° booth capturing stunning slow-motion at Dubai wedding"
                ...
                <p className="text-center text-muted-foreground" data-lovable-id="video_1_caption">
                  360° booth capturing stunning slow-motion at Dubai wedding
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="aspect-video rounded-lg overflow-hidden bg-muted">
                  <iframe
                    ...
                    height="100%"
                    src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                    title="Corporate product launch with branded 360 video booth"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    className="w-full h-full"
                  />
                ...
                <p className="text-center text-muted-foreground" data-lovable-id="video_2_caption">
                  Corporate product launch with branded 360 video booth
                </p>
              </div>
            </div>
