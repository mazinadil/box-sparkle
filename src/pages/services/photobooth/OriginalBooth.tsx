...
const OriginalBooth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Original Photo Booth Hire Dubai & UAE | Instant Prints | Box Entertainment</title>
        <meta name="description" content="Book our classic original photo booth for instant prints, digital sharing & fun props. Perfect for weddings, corporate events & parties in Dubai & UAE. Unlimited prints included." />
          ...
          <section id="video-reels" className="py-20 bg-muted/30 -mx-4 lg:-mx-8 px-4 lg:px-8 mb-20">
            <div className="container mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div>
                  <div className="relative aspect-video rounded-lg overflow-hidden shadow-xl mb-4">
                    <iframe
                      data-lovable-id="video_1_embed"
                      className="w-full h-full"
                      src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                      title="Original Photo Booth at Dubai Wedding"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    />
                  </div>
                  <p className="text-center text-muted-foreground" data-lovable-id="video_1_caption">
                    Original Photo Booth at luxury Dubai wedding – guests loving the instant prints
                  </p>
                </div>
                ...
                <div>
                  <div className="relative aspect-video rounded-lg overflow-hidden shadow-xl mb-4">
                    <iframe
                      data-lovable-id="video_2_embed"
                      className="w-full h-full"
                      src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                      title="Photo Booth at Corporate Event Dubai"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    />
                  </div>
                  <p className="text-center text-muted-foreground" data-lovable-id="video_2_caption">
                    Corporate gala with branded photo booth – professional and fun
                  </p>
                </div>
              </div>
