...
const MirrorBoothBackdrop = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mirror Booth with Custom Backdrop Dubai | Interactive Photo Booth | Box Entertainment</title>
        <meta name="description" content="Book interactive mirror photo booth with professional custom backdrop in Dubai & UAE. Touch-screen technology + themed backdrops for weddings, corporate events & parties." />
            ...
            <div className="lg:grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative mb-8 lg:mb-0">
                ...
                <img
                  ...
                  alt="Interactive mirror photo booth with custom themed backdrop at Dubai event"
              ...
              <div className="space-y-4">
                <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                  <iframe
                    ...
                    title="Mirror booth with backdrop at Dubai wedding"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                  />
                </div>
                <p className="text-center text-muted-foreground">
                  Watch our interactive mirror booth in action at a Dubai wedding
                </p>
              </div>
              <div className="space-y-4">
                <div className="aspect-video bg-muted rounded-lg overflow-hidden">
                  <iframe
                    className="w-full h-full"
                    src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                    title="Corporate event with branded backdrop and mirror booth"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                  />
                </div>
                <p className="text-center text-muted-foreground">
                  Corporate event guests enjoying the touch-screen mirror experience
                </p>
              </div>
            </div>
