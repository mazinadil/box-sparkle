...
const DJs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Professional DJs Dubai | Wedding & Corporate Event DJs | Box Entertainment</title>
        <meta name="description" content="Book professional DJs in Dubai for weddings, corporate events, and parties. Experienced DJs with top equipment. House, EDM, Arabic, Bollywood & open format music." />
