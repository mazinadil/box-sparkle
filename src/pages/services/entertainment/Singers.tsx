...
const Singers = () => {
  ...
  const singers = [
    {
      name: "Lina",
      role: "International Pop & Soul Vocalist",
      image: "/images/singers/lina.webp",
      description: "International sensation with a powerful voice spanning pop, soul, and contemporary hits. Known for captivating performances at luxury Dubai venues and corporate galas. Fluent in multiple languages with a diverse repertoire from classic ballads to modern chart-toppers.",
      tags: ["Pop", "Soul", "International", "Multilingual"]
    },
    {
      name: "Ryan",
      role: "Acoustic Singer-Songwriter",
      image: "/images/singers/ryan.webp",
      description: "Soulful acoustic performer specializing in intimate wedding ceremonies and lounge settings. Guitar and vocals creating warm, personal atmospheres with stripped-back arrangements of classics and contemporary favorites.",
      tags: ["Acoustic", "Weddings", "Singer-Songwriter", "Intimate"]
    },
    {
      name: "Sophia Laurent",
      role: "Jazz & Standards Specialist",
      image: "/images/singers/sophia-laurent.webp",
      description: "Elegant jazz vocalist bringing timeless sophistication to upscale events. Specializing in jazz standards, swing, and bossa nova with a silky-smooth voice perfect for cocktail hours and intimate dinners.",
      tags: ["Jazz", "Standards", "Luxury Events", "Sophisticated"]
    },
    {
      name: "Marcus Steel",
      role: "R&B & Contemporary Performer",
      image: "/images/singers/marcus-steel.webp",
      description: "Dynamic R&B and contemporary vocalist with chart-topping energy. Specializes in modern hits, soul classics, and high-energy performances that get guests on the dance floor at corporate events and celebrations.",
      tags: ["R&B", "Contemporary", "High Energy", "Dance Floor"]
    },
    {
      name: "Aria Delacroix",
      role: "Classical & Opera Soprano",
      image: "/images/singers/aria-delacroix.webp",
      description: "Classically trained soprano bringing operatic elegance to prestigious events. Perfect for ceremony performances, gala openings, and luxury celebrations requiring sophisticated classical vocal artistry.",
      tags: ["Classical", "Opera", "Ceremonies", "Prestigious"]
    },
    {
      name: "The Vocal Duo",
      role: "Harmony Specialists",
      image: "/images/singers/vocal-duo.webp",
      description: "Male-female vocal duo creating stunning harmonies across pop, rock, and soul. Perfect for wedding receptions and corporate events with dynamic two-part vocals and engaging stage presence that entertains all ages.",
      tags: ["Duo", "Harmonies", "Versatile", "Weddings"]
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our singers cover diverse genres including pop, jazz, classical/opera, R&B, soul, acoustic/singer-songwriter, contemporary hits, Arabic music, and wedding classics. Each singer has their specialty, and we match vocalists to your event's style, audience preferences, and desired atmosphere."
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>Professional Singers Dubai | Wedding & Corporate Vocalists | Box Entertainment</title>
      ...
      <StructuredData
        data={{
          ...
          serviceType: ["Wedding Singer", "Corporate Entertainment", "Solo Vocalist", "Jazz Singer", "Pop Singer", "Classical Singer", "Vocal Duo"],
          areaServed: {
            "@type": "City",
            name: "Dubai",
