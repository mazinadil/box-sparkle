...
const saxophonists = [
  {
    name: "Alex",
    role: "Jazz & Contemporary Specialist",
    image: "/images/saxophonists/alex.webp",
    description: "One of Dubai's most soulful saxophonists, blending jazz improvisation with funky rhythms and catchy tunes. Professional musician known for expressive playing that captivates audiences at luxury venues and corporate events.",
    tags: ["Jazz", "Funk", "Contemporary", "Corporate Events"]
  },
  {
    name: "Sophia Rivers",
    role: "Electronic & DJ Collaboration",
    image: "/images/saxophonists/sophia-rivers.webp",
    description: "Innovative saxophonist specializing in electronic music collaborations with DJs. Creates dynamic fusion performances combining live sax with house, techno, and EDM beats for high-energy celebrations and nightlife events.",
    tags: ["Electronic", "DJ Collab", "House Music", "High Energy"]
  },
  {
    name: "Marcus Bennett",
    role: "Classical & Wedding Specialist",
    image: "/images/saxophonists/marcus-bennett.webp",
    description: "Classically trained saxophonist bringing elegance to ceremonies and receptions. Specializes in romantic ballads, classical pieces, and contemporary love songs perfect for wedding ceremonies and cocktail hours.",
    tags: ["Classical", "Weddings", "Romantic", "Ceremonies"]
  },
  {
    name: "Layla Al-Mansour",
    role: "Arabic & Cultural Fusion",
    image: "/images/saxophonists/layla-almansour.webp",
    description: "Unique fusion artist blending traditional Arabic melodies with modern saxophone styling. Perfect for multicultural events and celebrations honoring Dubai's rich cultural heritage with contemporary flair.",
    tags: ["Arabic Fusion", "Cultural", "Traditional", "International"]
  },
  {
    name: "David Chen",
    role: "Pop & Rock Performer",
    image: "/images/saxophonists/david-chen.webp",
    description: "Energetic performer specializing in pop hits and rock classics. Brings crowd-pleasing energy to parties and corporate entertainment with recognizable melodies and dynamic stage presence.",
    tags: ["Pop", "Rock", "Party Music", "Crowd Pleaser"]
  },
  {
    name: "The Sax & Beats Duo",
    role: "Saxophone & Percussion Ensemble",
    image: "/images/saxophonists/sax-beats-duo.webp",
    description: "Dynamic duo combining live saxophone with percussionist for vibrant, rhythmic performances. Perfect for beach parties, outdoor events, and celebrations needing infectious energy and visual entertainment.",
    tags: ["Duo", "Percussion", "Outdoor Events", "Rhythmic"]
  }
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our saxophonists are versatile across genres including jazz (swing, bebop, smooth jazz), pop hits, classical pieces, electronic/house music collaborations, rock classics, blues, Arabic fusion, and contemporary love songs. Each performer has specialties, and we match saxophonists to your event's style and atmosphere."
  },
  {
...
const Saxophonists = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Professional Saxophonists Dubai | Wedding & Corporate Saxophone Performances | Box Entertainment</title>
        <meta name="description" content="Book professional saxophonists in Dubai for weddings, corporate events, and parties. Jazz, pop, electronic, and classical saxophone. DJ collaborations available." />
      ...
      <StructuredData
        data={{
          ...
          serviceType: ["Wedding Saxophonist", "Corporate Entertainment", "Jazz Saxophone", "DJ Collaboration", "Classical Saxophone", "Electronic Sax"],
          areaServed: {
            "@type": "City",
            name: "Dubai",
