...
const Magicians = () => {
  return <>
      <Helmet>
        ...
        <meta name="description" content="Book world-class magicians for your Dubai event. Close-up magic, stage illusions, mentalism, and corporate entertainment. Experienced performers for weddings, parties, and corporate events." />
