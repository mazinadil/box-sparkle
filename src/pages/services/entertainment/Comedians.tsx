  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Book professional comedians in Dubai. Stand-up comedy, corporate MC hosting, and event entertainment. Award-winning comedians for weddings, parties, and corporate events." />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="overflow-hidden hover-lift group">
                <div className="relative aspect-[3/4] overflow-hidden">
                  <img 
                    src="/images/comedians/darryl-rees.webp" 
