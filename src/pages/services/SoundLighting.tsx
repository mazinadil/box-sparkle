...
const SoundLighting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sound & Lighting Services Dubai | Box Entertainment</title>
        <meta name="description" content="Professional sound and lighting services in Dubai. Festoon lights, fairy lights, and complete audio-visual solutions for events." />
