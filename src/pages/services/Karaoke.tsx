...
const Karaoke = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Karaoke Rental Dubai | Professional Systems & 100,000+ Songs | Box Entertainment</title>
        <meta name="description" content="Professional karaoke rental in Dubai from AED 1,800. 100,000+ songs in 20+ languages. Wireless mics, LED screens, professional sound. Perfect for parties, weddings, corporate events." />
