...
import { Headphones, Heart, Waves, Sun, Users, Music, Volume2, 
         Radio, Settings, Check, Leaf, Sparkles, Mountain, Calendar } from "lucide-react";
...
const SilentYoga = () => {
  const { ref: heroRef, isVisible: heroVisible } = useIntersectionObserver({ threshold: 0.1, triggerOnce: true });
  const { isLoaded: heroImageLoaded, error: heroImageError } = useImageLoader("/images/services/silent-yoga-bg.webp");

  return (
    <>
      <Helmet>
        <title>Silent Yoga Dubai | Wireless Headsets for Outdoor & Corporate Yoga | Box Entertainment</title>
        <meta name="description" content="Book silent yoga sessions in Dubai with wireless headsets. Perfect for beach yoga, corporate wellness, meditation, and outdoor group classes. From AED 1,500. Available across Dubai." />
      ...
      <main className="min-h-screen pt-24 pb-16">
        ...
        <section ref={heroRef} className="container mx-auto px-4 lg:px-8 mb-20">
          ...
          <div className="lg:grid lg:grid-cols-2 gap-12 mt-12">
            ...
            <div className="relative overflow-hidden rounded-lg h-[500px] lg:h-[600px] mb-8 lg:mb-0">
              ...
              <img
                src="/images/services/silent-yoga-bg.webp"
                alt="Silent yoga session with wireless headsets on Dubai beach at sunrise"
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0">
            <img 
              src="/images/services/silent-yoga-bg.webp" 
              alt="Silent yoga equipment and wireless headsets setup for wellness sessions"
        ...
        <section className="container mx-auto px-4 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative overflow-hidden rounded-lg">
              <img
                src="/images/services/silent-yoga-bg.webp"
                alt="Group practicing silent yoga outdoors with wireless headsets at sunset"
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0">
            <img 
              ...
              alt="Various silent yoga and wellness events in Dubai"
              className="w-full h-full object-cover"
              loading="lazy"
            />
