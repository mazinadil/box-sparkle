...
const SilentDisco = () => {
  return (
    <>
      <Helmet>
        <title>Silent Disco Party Dubai | Wireless Headphones Rental | Box Entertainment</title>
        <meta name="description" content="Book professional silent disco in Dubai with 3-channel wireless headphones, multiple DJs, and technical support. Perfect for parties, corporate events, weddings, and outdoor venues. From AED 3,000 for 50+ guests." />
      ...
      <div className="lg:grid lg:grid-cols-2 gap-12 mt-12">
        ...
        <div className="relative overflow-hidden rounded-lg h-[500px] lg:h-[600px] mb-8 lg:mb-0">
          <img
            src="/images/services/silent-disco-hero.webp"
            alt="Silent disco party in Dubai with wireless LED headphones and multiple music channels"
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0">
            <img 
              src="/images/services/silent-disco-bg.webp" 
              alt="Silent disco equipment and headphones setup"
        ...
        <section id="how-it-works" className="container mx-auto px-4 lg:px-8 py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative overflow-hidden rounded-lg">
              <img
                src="/images/services/silent-disco-hero.webp"
                alt="Guests enjoying multi-channel silent disco with LED headphones showing different colors"
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0">
            <img 
              ...
              alt="Various event types showcasing silent disco applications"
              className="w-full h-full object-cover"
              loading="lazy"
            />
