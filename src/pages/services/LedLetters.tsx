...
const LedLetters = () => {
  return (
    <>
      <Helmet>
        <title>LED Light Up Letters Rental Dubai | LOVE Letters & Custom Messages | Box Entertainment</title>
        <meta name="description" content="Stunning LED light-up letters rental in Dubai. 4-5ft illuminated LOVE letters, custom messages, initials, and numbers. Perfect for weddings, parties, corporate events. Professional setup included." />
            ...
            <div className="space-y-4">
              <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
                <iframe
                  ...
                  title="LED LOVE letters illuminated at Dubai wedding reception creating magical photo backdrop"
              ...
              <p className="text-center text-muted-foreground">
                LED LOVE letters at Dubai wedding reception
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
                <iframe
                  ...
                  height="100%"
                  src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                  title="Custom LED letters and initials at corporate event with branded messaging"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                  className="w-full h-full"
                />
              ...
              <p className="text-center text-muted-foreground">
                Custom LED letters at corporate brand activation
              </p>
            </div>
          </div>
