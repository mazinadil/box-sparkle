...
const Corporate = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Corporate Event Entertainment Dubai | Product Launches, Conferences, Galas | Box Entertainment</title>
        <meta name="description" content="Professional corporate event entertainment in Dubai. Photo booths, DJs, sound systems, silent headsets, LED displays. Trusted by leading companies for product launches, conferences, and team building." />
