...
const Weddings = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Wedding Entertainment & Planning Dubai | Complete Wedding Services | Box Entertainment</title>
        <meta 
          name="description" 
          content="Transform your Dubai wedding with complete planning and entertainment services. Professional DJs, live music, photo booths, lighting, décor, and coordination. Custom packages for your dream celebration." 
        />
        <meta 
          name="keywords" 
        ...
        />
        <link rel="canonical" href="https://boxentertainment.ae/events/weddings" />
        ...
        <meta property="og:url" content="https://boxentertainment.ae/events/weddings" />
      </Helmet>
