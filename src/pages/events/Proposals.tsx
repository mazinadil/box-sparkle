...
const Proposals = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Marriage Proposal Planning Dubai | Romantic Proposal Services | Box Entertainment</title>
        <meta name="description" content="Plan the perfect marriage proposal in Dubai. Professional services including romantic setups at Atlantis, Burj Khalifa, Jabal Jais, desert camps. Photography, live music, complete coordination from AED 5,000." />
          ...
          <div className="space-y-4">
            <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
              <iframe
                ...
                title="Romantic beach proposal Dubai with sunset LED letters and live violinist creating magical moment"
            ...
            <p className="text-center text-muted-foreground">
              Beach sunset proposal with LOVE letters and live violin
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-xl">
              <iframe
                ...
                height="100%"
                src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                title="Burj Khalifa rooftop marriage proposal Dubai with city skyline and romantic lighting setup"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="w-full h-full"
              />
            ...
            <p className="text-center text-muted-foreground">
              Rooftop proposal with Burj Khalifa views and ambient lighting
            </p>
          </div>
        </div>
