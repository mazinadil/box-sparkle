  ...
  const mobileMenuData = {
    ...
    events: {
      ...
      items: [
        ...
        { title: "Weddings", link: "/events/weddings" },
      ...
      <nav className="container mx-auto px-4 lg:px-8 py-2">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2 hover-lift">
            <img src={boxLogoPng} alt="Box Entertainment" className="w-[133px] h-[67px]" width="133" height="67" loading="eager" />
          </Link>
                  ...
                  <NavigationMenuContent>
                    <div className="w-[300px] p-4 bg-card">
                      <div className="grid gap-3">
                        ...
                        <Link to="/events/weddings" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-muted hover:text-primary">
